      ...
      <div class="row content-padding-top">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo base_url(); ?>Location/save_location">
              
              <div class="box-body">

                <div class="form-group">
                    <label for="exampleInputEmail1">Location</label><span style="color: red;">**</span>
                    <input type="text" class="form-control" id="id_location" name="location" placeholder="Location" value="<?php if(isset($_POST['location'])){ echo $_POST['location']; } ?> ">
                     <span style="color: red"><?php echo form_error('location');?></span>
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Area</label><span style="color: red;">**</span>
                    <input type="text" class="form-control" id="id_place" name="area" placeholder="Area" value="<?php if(isset($_POST['area'])){ echo $_POST['area']; } ?> ">
                     <span style="color: red"><?php echo form_error('place');?></span>
                </div>


                <div class="form-group">
                  <label for="exampleInputEmail1">Building Name</label><span style="color: red;">**</span>
                  <input type="text" class="form-control" id="id_building_name" name="building_name" placeholder="Building Name" value="<?php if(isset($_POST['building_name'])){ echo $_POST['building_name']; } ?> ">
                  <span style="color: red"><?php echo form_error('building_name');?></span>
                </div>
