				...
				<div class="form-group row t-form-group">
					...
					<div class="col-sm-12">
						<div class="text-feild-height already">
							<p>
								 Don't have an account?<a href="#" data-toggle="modal" data-target="#resiter-form" data-dismiss="modal" onclick="hide_signin();" > Register.</a>
							</p>
						</div>
					</div>
			...
			<div class="t-banner-form-area form-area">
				...
				<div class="form-group row t-form-group">
					<div class="col-sm-12">
						<div class="text-feild-height already">
							<p>
								 Already have an account ? <a href="#" data-toggle="modal" data-target="#signin" data-dismiss="modal" onclick="hide_regi();">Sign In</a>
							</p>
						</div>
					</div>
...
//	 document.getElementById('resiter-form').style.display = "none";
	 // document.getElementById('modal-backdrop').style.display = "none";
	 // modal-backdrop 
	var modal = document.getElementById('resiter-form');
