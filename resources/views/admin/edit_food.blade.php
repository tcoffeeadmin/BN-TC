      ...
      <div class="row content-padding-top">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          @if(count($errors) > 0)
            ...
            @endif
            <form role="form" method="post" action="{{ url('/update_biryani') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">

                <div class="form-group{{ $errors->has('category') ? 'has-error': '' }}">
                  <label for="code">CODE</label><span style="color: red;">**</span>
                  <input type="text" name="code" class="form-control" value="<?php if(isset($v->code)){ echo $v->code; } ?> " id="exampleInputEmail1" placeholder="Code" >  <span style="color: red"><?php //echo form_error('code');?></span>
                </div>


                <div class="form-group{{ $errors->has('name') ? 'has-error': '' }}">
                  <label for="name">Name</label><span style="color: red;">**</span>
                  <input type="text" name="name" class="form-control" value="<?php if(isset($v->name)){ echo $v->name; } ?>" id="exampleInputEmail1" placeholder="Name">  <span style="color: red"><?php //echo form_error('name');?></span>
                </div>
        
                <div class="form-group{{ $errors->has('description') ? 'has-error': '' }}">
                  <label for="description">Description</label><span style="color: red;">**</span>
                  <textarea name="description" class="form-control" rows="3" placeholder="Description"><?php if(isset($v->description)){ echo $v->description; } ?></textarea>  <span style="color: red"><?php //echo form_error('description');?></span>
                </div>
              ...
              <label for="price">Price</label><span style="color: red;">**</span>
                  <input type="text" name="price" class="form-control" value="<?php if(isset($v->price)){ echo $v->price; } ?>" id="exampleInputEmail1" placeholder="Price" onkeypress="return isNumber(event)">  
                  <span style="color: red"><?php //echo form_error('price');?></span>
      				...
      				<div class="col-xs-6 pa-left-rmve">
      				  ...
      				  <label for="gst">Gst(%)</label><span style="color: red;">**</span>
                         ...
                         <input type="text" name="gst" class="form-control" value="<?php if(isset($v->gst)){ echo $v->gst; } ?>" placeholder="Gst(%)" onkeypress="return isNumber(event)">  
